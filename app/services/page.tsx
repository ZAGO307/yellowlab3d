...
const PLANS = [
  {
    ...
    rates: [{ label: "FDM (poids matière)", price: "0,07 CHF/g" }],
    cta: "Commander",
  },
  {
    name: "Pro",
    ...
    features: [
      ...
      "Délai prioritaire 48h",
      "Livraison suivie express",
      "Support dédié",
    ],
    rates: [
      { label: "FDM Pro (0.1 mm)", price: "0,10 CHF/g" },
      { label: "Résine standard", price: "0,20 CHF/g" },
      { label: "Résine Engineering", price: "0,30 CHF/g" },
    ],
    cta: "Commander Pro",
  },
  {
    name: "Studio",
    subtitle: "Grandes séries",
    price: null,
    unit: "sur devis",
    highlight: false,
    features: [
    ...
    rates: [
      { label: "Volume > 1 kg (FDM)", price: "0,05 CHF/g" },
      { label: "Volume > 500 g (Résine)", price: "0,15 CHF/g" },
    ],
...
const MATERIALS = [
  { name: "PLA", tech: "FDM", use: "Décoration, prototypes, pièces légères", temp: "60°C", prix: "0,07 CHF/g" },
  { name: "PETG", tech: "FDM", use: "Usage général, pièces solides et résistantes", temp: "80°C", prix: "0,08 CHF/g" },
  { name: "ABS", tech: "FDM", use: "Pièces techniques, résistance thermique", temp: "100°C", prix: "0,09 CHF/g" },
  { name: "Résine Std", tech: "Résine", use: "Détails fins, figurines, bijoux", temp: "50°C", prix: "0,20 CHF/g" },
  { name: "Résine Eng.", tech: "Résine", use: "Dentaire, prototypage précis", temp: "70°C", prix: "0,30 CHF/g" },
  { name: "Résine Flex.", tech: "Résine", use: "Pièces souples et détaillées", temp: "40°C", prix: "0,25 CHF/g" },
];
